...
public class DaftarPendingAdapterFI extends ArrayAdapter<DaftarPendingItemFI> {

    private Context context;
    private ArrayList<DaftarPendingItemFI> navDrawerItems;

    public DaftarPendingAdapterFI(Context context, List<DaftarPendingItemFI> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        DaftarPendingItemFI item = getItem(position);
