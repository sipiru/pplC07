...
public class DaftarDisetujuiAdapterK extends ArrayAdapter<DaftarDisetujuiItemK> {

    private Context context;
    private ArrayList<DaftarDisetujuiItemK> navDrawerItems;

    public DaftarDisetujuiAdapterK(Context context, List<DaftarDisetujuiItemK> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        DaftarDisetujuiItemK item = getItem(position);
