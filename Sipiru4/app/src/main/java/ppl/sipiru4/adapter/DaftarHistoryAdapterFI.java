...
public class DaftarHistoryAdapterFI extends ArrayAdapter<DaftarHistoryItemFI> {

    private Context context;
    private ArrayList<DaftarHistoryItemFI> navDrawerItems;

    public DaftarHistoryAdapterFI(Context context, List<DaftarHistoryItemFI> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        DaftarHistoryItemFI item = getItem(position);
