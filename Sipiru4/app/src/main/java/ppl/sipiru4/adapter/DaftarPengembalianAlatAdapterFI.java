...
public class DaftarPengembalianAlatAdapterFI extends ArrayAdapter<DaftarPengembalianAlatItemFI> {

    private Context context;
    private ArrayList<DaftarPengembalianAlatItemFI> navDrawerItems;

    public DaftarPengembalianAlatAdapterFI(Context context, List<DaftarPengembalianAlatItemFI> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            ...
            viewHolder.status = (TextView) convertView.findViewById(R.id.alat);
