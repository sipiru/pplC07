...
public class DaftarPendingAdapterP extends ArrayAdapter<DaftarPendingItemP> {

    private Context context;
    private ArrayList<DaftarPendingItemP> navDrawerItems;

    public DaftarPendingAdapterP(Context context, List<DaftarPendingItemP> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        DaftarPendingItemP item = getItem(position);
