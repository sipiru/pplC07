...
public class DaftarPendingAdapterK extends ArrayAdapter<DaftarPendingItemK> {

    private Context context;
    private ArrayList<DaftarPendingItemK> navDrawerItems;

    public DaftarPendingAdapterK(Context context, List<DaftarPendingItemK> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        DaftarPendingItemK item = getItem(position);
